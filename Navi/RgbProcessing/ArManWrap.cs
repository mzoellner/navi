// Source Code from: http://www.brains-n-brawn.com/default.aspx?vDir=wpfaugreal
//----------------------------------------------
...
namespace Navi.RgbProcessing
{
    ...
    public class ArManWrap
    {
        ...
        /// <returns></returns>
        [DllImport("ARToolKitPlus.dll", SetLastError = true, CallingConvention = CallingConvention.Cdecl)]
